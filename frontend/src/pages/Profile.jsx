...
const s = {
  ...
  sectionTitle: { fontSize: '1rem', fontWeight: 700, color: '#0f2d1a', marginBottom: 20, display: 'flex', alignItems: 'center', gap: 8 },
  ...
  bmiLabel: { fontSize: '0.75rem', color: '#6b8f76', fontWeight: 500 },
  bmiValue: { display: 'flex', alignItems: 'baseline', gap: 2 },
  bmiCat: { fontSize: '0.9rem', fontWeight: 600, color: '#2d5a3d' },
  chips: { display: 'flex', flexWrap: 'wrap', gap: 8, marginTop: 4 },
  chip: {
    padding: '5px 14px', border: '1.5px solid rgba(34,197,94,0.25)', borderRadius: 20,
    background: 'rgba(255,255,255,0.7)', cursor: 'pointer', fontSize: '0.8rem',
    fontWeight: 500, color: '#2d5a3d', transition: 'all 0.2s', textTransform: 'capitalize',
  },
  chipActive: { background: 'rgba(34,197,94,0.15)', borderColor: '#22c55e', color: '#15803d', fontWeight: 700 },
  chipDanger: { background: 'rgba(239,68,68,0.1)', borderColor: '#ef4444', color: '#b91c1c', fontWeight: 700 },
}
